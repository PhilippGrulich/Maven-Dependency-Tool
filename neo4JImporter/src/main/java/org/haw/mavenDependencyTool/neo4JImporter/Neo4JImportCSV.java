...
public class Neo4JImportCSV {
	...
	private void createVersion(Project project) throws SQLException {
		...
		String key = project.getGroupId() + "_" + project.artifactId + "_" + version;
		data.println(String.format("%s;%s;%s;", key, version, "version"));
	...
	private void createArtifactVersionRelation(Project project) throws SQLException {
		...
		String versionKey = project.getGroupId() + "_" + project.artifactId + "_" + project.getVersion();
	...
	private void createDependencyRelation(Project project) throws SQLException {
		...
		if (deps!=null) {
			...
			deps.forEach(dependency->{
				...
				String dependencyVersionKey = dependency.groupId + "_" + dependency.artifactId + "_" + dependencyVersion;
